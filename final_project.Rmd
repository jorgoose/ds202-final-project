...
We can plot the danceability of songs by the GDP per capita of the country.
...
For more insight into the data, we can create the same scatterplot, except this time, color the points based on their quartile of GDP per capita.
